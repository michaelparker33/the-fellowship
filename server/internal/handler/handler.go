...
func New(queries *db.Queries, txStarter txStarter, hub *realtime.Hub, bus *events.Bus, emailService *service.EmailService, s3 storage.FileStorage, cfSigner *auth.CloudFrontSigner) *Handler {
